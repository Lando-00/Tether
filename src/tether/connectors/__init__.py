...
exposes one or more :class:`tether.core.interfaces.Tool` instances
...
- :class:`SecretsProvider` interface (``tether.core.secrets``)
- :class:`ConnectorsSettings` config schema (``tether.config.settings``)
