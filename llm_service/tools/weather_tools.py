"""
weather_tools.py - Weather-related tools using a real-time weather API.

This module provides weather-related tools that fetch live data from the
Open-Meteo API. It replaces the previous simulated data with real-world
weather information.
"""
...
import requests
from llm_service.tools import register_tool
...
@register_tool
def get_weather(location: str, unit: Literal["celsius", "fahrenheit"] = "celsius") -> Dict[str, Any]:
...
@register_tool
def get_forecast(location: str, days: int = 3, unit: Literal["celsius", "fahrenheit"] = "celsius") -> Dict[str, Any]:
